...
module.exports = {
	...
	roots: ['<rootDir>/packages/common/src'],
	...
	transform: {
		'^.+\\.[t|j]sx?$': '<rootDir>/jest/jest-preprocess.js',
	},
	...
	transformIgnorePatterns: [
		...
		// 'node_modules',
		'node_modules/(?!(react-native|@react-native|react-native-webview|react-native-screens|react-native-gesture-handler|@react-navigation/.*|@react-native-community|react-native-iphone-x-helper|react-native-reanimated)/|expo(nent)?|@expo(nent)?/.*|@unimodules/.*|unimodules)',
	],
